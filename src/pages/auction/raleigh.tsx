...
export default function RaleighAuction() {
  return (
    <>
      {/* ── Hero ── */}
        ...
        <Container maxWidth="xl" sx={{ px: { xs: 2, sm: 3, md: 4 } }}>
          <Grid container spacing={{ xs: 5, md: 7 }}>
            <Grid size={{ xs: 12, md: 8 }}>
              ...
              <Typography variant="h4" sx={{ color: NAVY, fontSize: '1.25rem', mb: 2 }}>
                Auction Details
              </Typography>
              ...
              <Typography variant="h4" sx={{ color: NAVY, fontSize: '1.25rem', mt: 4, mb: 2 }}>
              ...
              <Paper elevation={0} sx={{ p: 3.5, border: '1px solid #e8ecf0', borderTop: `4px solid ${TEAL}`, borderRadius: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1.5, mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" sx={{ color: NAVY, fontWeight: 500 }}>3201 Durham Drive<br />Raleigh, NC 27603</Typography>
                  </Box>
                </Box>
                <Box sx={{ display: 'flex', gap: 1.5, mb: 2 }}>
